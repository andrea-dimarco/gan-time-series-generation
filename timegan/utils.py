...
def rnn_cell(module_name, hidden_dim):
  ...
  # TODO: don't need this just use gru or make different models ffs
...
def random_generator(batch_size, z_dim, T_mb, max_seq_len):
  ...
  '''
  # TODO: delete this and just use torch
  Z_mb = list()
...
def batch_generator(data, time, batch_size):
  ...
  '''
  # TODO: substitute this with a dataloader and use PyTorch
  no = len(data)
  idx = np.random.permutation(no)
