...
class Config:
    ...
    emb_hidden_dim: int = 8 #. . . . . . Dimension of the hidden layers for the embedder
    gen_hidden_dim: int = 8 #. . . . . . Dimension of the hidden layers for the generator
    rec_hidden_dim: int = 8 #. . . . . . Dimension of the hidden layers for the recovery
    dis_hidden_dim: int = 8 #. . . . . . Dimension of the hidden layers for the discriminator
    sup_hidden_dim: int = 8 #. . . . . . Dimension of the hidden layers for the supervisor
